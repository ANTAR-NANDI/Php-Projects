 ...
 <div class="container">
    <div class="card">
      <div class="card-header">
        <h3 class="text-center">Privacy Setting</h3>
      </div>
        <div class="card-body">
  ...
  <div class="col-sm-8">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title" style="color: green">Edit Eligibity</h5>  
    <form method="POST" action="privacy.php">
         <div class="form-group">
                    <label for="name" class="col-sm-10 col-form-label">Do you Want to give blood now??</label>
                            <select class="form-control" id="sel1" name="eligibility">
                                  <option>Yes</option>
                                  <option>No</option>
                        ...
                        <button class="btn btn-primary" name="submit" type="submit" value="submit">Save Change</button>
...
if(isset($_POST['submit']))
{
  ...
  $sql="UPDATE signup SET Eligibility='$eligibility' WHERE Email='$email'";
...
if($result)
{
                ...
                <h4 class="alert-heading"  >Eligibity Updated!</h4>
              </div>';
